  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item <?php if($_GET['page'] == 'home'){echo 'active';} ?>">
        <a class="nav-link" href="main.php?page=home"><i class="fas fa-home"></i> หน้าแรก <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item <?php if($_GET['page'] == 'shop'){echo 'active';} ?>">
        <a class="nav-link" href="main.php?page=shop"><i class="fas fa-shopping-cart"></i> ร้านค้า</a>
      </li>
      <li class="nav-item <?php if($_GET['page'] == 'reward'){echo 'active';} ?>">
        <a class="nav-link" href="main.php?page=reward"><i class="fas fa-tags"></i> แลกรางวัล</a>
      </li>
<li class="nav-item dropdown">
        ...
        <div class="dropdown-menu navy-dw-dark navy-shadow-dark" aria-labelledby="navbarDropdown">
          <a class="dropdown-item navy-dw-dark-item p-2" <?php if($_GET['page'] == 'pay'){echo 'style="color:white !important;"';} ?> href="main.php?page=pay"><i class="fas fa-credit-card"></i> เติมเงิน</a>
          <a class="dropdown-item navy-dw-dark-item p-2" <?php if($_GET['page'] == 'usecode'){echo 'style="color:white !important;"';} ?> href="main.php?page=usecode"><i class="fas fa-star"></i> สะสมแต้ม</a>
          <a class="dropdown-item navy-dw-dark-item p-2" <?php if($_GET['page'] == 'trade'){echo 'style="color:white !important;"';} ?> href="main.php?page=trade"><i class="fas fa-gift"></i> โอนเงินให้เพื่อน</a>
          <a class="dropdown-item navy-dw-dark-item p-2" <?php if($_GET['page'] == 'contact'){echo 'style="color:white !important;"';} ?> href="main.php?page=contact"><i class="fas fa-user-shield"></i> ติดต่อทีมงาน</a>
        </div>
      </li>
    </ul>
